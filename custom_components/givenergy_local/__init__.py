...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # Options (tariff entities for the money sensors) only take effect at
    # platform setup, so a change must reload the entry.
...
async def _async_options_updated(hass: HomeAssistant, entry: ConfigEntry) -> None:
    """Reload the entry so changed options re-enumerate the platforms."""
